...
import { AgregarDialogComponent } from './agregar/agregar.component';
...
export class ExampleDataSource extends DataSource<Usuario> {
  ...
  connect(): Observable<Usuario[]> {
    ...
    return merge(...displayDataChanges).pipe(map( () => {
        // Filter data
        this.filteredData = this._exampleDatabase.data.slice().filter((u: Usuario) => {
          const searchStr = (u.nombre + u.apellido + u.rut + u.correo).toLowerCase();
